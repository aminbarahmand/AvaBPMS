...
{
    public class TestWFController : Controller
    {
        private readonly int poolId=1;
        ...
        public TestWFController(WorkFlowDesignService workFlowDesignService, WorkFlowExecutionService workFlowExecutionService, IUser user)
        {
